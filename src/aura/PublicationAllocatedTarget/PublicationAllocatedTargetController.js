({
    ...
    addProductCategoryButton: function (component, event, helper) {
    ...
    delPublication: function (component, event, helper) {
        ...
        if (delPublic.length > 0 || delProdCateg.length > 0) {
            ...
            delPub.setCallback(this, function (response) {
                ...
                console.log(state);
                if (state === 'SUCCESS') {
                    component.set("v.resultTableTarget", response.getReturnValue());
    ...
    closeDirectoryBox: function (component, event, helper) {
        ...
        if (x[0].style.display === "none") {
            ...
            if (getAllIdCategory != null) {
                item[event.getSource().get("v.requiredIndicatorClass")].publicationDirectoryAllocatedTarget = 0;
                for (var i = 0; i < getAllIdCategory.length; i++) {
                    if (event.getSource().get("v.requiredIndicatorClass") === component.find("focusIdDirectory")[i].get("v.requiredIndicatorClass")) {
                        item[event.getSource().get("v.requiredIndicatorClass")].publicationDirectoryAllocatedTarget += component.find("focusIdDirectory")[i].get("v.value");
                    }
                }
            }
    ...
    closeInsightsBox: function (component, event, helper) {
        ...
        if (x[0].style.display === "none") {
            ...
            var getAllIdCategory = component.find("focusIdInsights");
            if (getAllIdCategory != null) {
                item[event.getSource().get("v.requiredIndicatorClass")].publicationInsightsAllocatedTarget = 0;
                if (!Array.isArray(getAllIdCategory)) {
                    if (event.getSource().get("v.requiredIndicatorClass") === component.find("focusIdInsights").get("v.requiredIndicatorClass")) {
                        item[event.getSource().get("v.requiredIndicatorClass")].publicationInsightsAllocatedTarget = component.find("focusIdInsights").get("v.value");
                    }
                } else {
                    for (var i = 0; i < getAllIdCategory.length; i++) {
                        if (event.getSource().get("v.requiredIndicatorClass") === component.find("focusIdInsights")[i].get("v.requiredIndicatorClass")) {
                            item[event.getSource().get("v.requiredIndicatorClass")].publicationInsightsAllocatedTarget = component.find("focusIdInsights")[i].get("v.value");
                        }
                    }
                }
            }
