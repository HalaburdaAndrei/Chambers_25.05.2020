({
	...
	toggleTotalRow: function (cmp, evt) {
		...
		var res = cmp.get("v.res");
		res[evt.target.dataset.publicationtypecategoryindex].publicationTypes[evt.target.dataset.publicationtypeindex].totalRows[evt.target.dataset.totalrowindex].expanded = !res[evt.target.dataset.publicationtypecategoryindex].publicationTypes[evt.target.dataset.publicationtypeindex].totalRows[evt.target.dataset.totalrowindex].expanded;
		cmp.set("v.res", res);
	},
	toggleTotal: function (cmp, evt) {
		...
		var res = cmp.get("v.res");
		res[evt.target.dataset.publicationtypecategoryindex].publicationTypes[evt.target.dataset.publicationtypeindex].totalRows[evt.target.dataset.totalrowindex].productTotals[evt.target.dataset.totalindex].expanded = !res[evt.target.dataset.publicationtypecategoryindex].publicationTypes[evt.target.dataset.publicationtypeindex].totalRows[evt.target.dataset.totalrowindex].productTotals[evt.target.dataset.totalindex].expanded;
		cmp.set("v.res", res);
	},
